...
<body>
    ...
    <div class="container2">
        ...
        <ul>
            <li>200 g kacang merah kering</li>
            <li>500 g iga sapi berdaging, potong-potong</li>
            <li>2 liter air</li>
            <li>2 sdm mentega</li>
            <li>50 g bawang bombay, cincang kasar</li>
            <li>3 siung bawang putih, memarkan</li>
            <li>2 batang daun bawang, potong kasar</li>
            <li>2 batang seledri, potong kasar</li>
            <li>3 butir cengkeh</li>
            <li>1/2 butir biji pala, memarkan</li>
